-- Consolidated Security & Collaboration Migration (FIXED SYNTAX)
-- Created: 2026-01-04
...
DROP POLICY IF EXISTS "Users and collaborators can view themes" ON themes;
...
DROP POLICY IF EXISTS "Users and editors can update themes" ON themes;
...
DROP POLICY IF EXISTS "Users and collaborators can view subthemes" ON subthemes;
...
DROP POLICY IF EXISTS "Users and editors can update subthemes" ON subthemes;
...
DROP POLICY IF EXISTS "Users and collaborators can view tasks" ON tasks;
...
DROP POLICY IF EXISTS "Users and editors can update tasks" ON tasks;
...
DROP POLICY IF EXISTS "Users and collaborators can view goals" ON goals;
...
DROP POLICY IF EXISTS "Users and editors can update goals" ON goals;
...
DROP POLICY IF EXISTS "Users and editors can update projects" ON projects;
...
DROP POLICY IF EXISTS "Users and collaborators can view milestones" ON project_milestones;
...
DROP POLICY IF EXISTS "Users and editors can update milestones" ON project_milestones;
...
DROP POLICY IF EXISTS "Anyone can view public links" ON share_links;
CREATE POLICY "Anyone can view public links" ON share_links FOR SELECT 
